            ...
            deals.forEach(deal => {
              ...
              if (deal.title && deal.merchantName) {
                ...
                locationDeals.push({
                  ...
                  confidence: verifiedBusiness ? 0.7 : 0.4, // Lower confidence because deals are synthetic
                  ...
                  dealVerified: false, // IMPORTANT: Deals are synthetic, not verified from actual sources
                  merchantVerified: !!verifiedBusiness, // Merchant is verified via Google Places
                  syntheticDeal: true, // Flag that this deal was generated by LLM, not from real source
                });
                
                console.log(`[DealFetchingAgent] ✅ Added deal: "${deal.title}" for ${finalMerchantName}`);
                console.log(`[DealFetchingAgent]   Merchant: ${verifiedBusiness ? '✅ Verified' : '❌ Unverified'} | Deal: ⚠️  Synthetic (not verified)`);
              } else {
